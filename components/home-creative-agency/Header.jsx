            ...
            <div className="caption mb-100">
              <div className="row">
                <div className="col-lg-8">
                  <h1 className="text-u">The Tech <span className='line_through'>Agency</span></h1>
                  <h1 className="text-u">  <span className='underline'>Team</span> You </h1>
                </div>
              ...
              <div className="row text-left align-items-center">
                <div className="col-lg-3 order-md-2">
                  <p>
                    Asynk is a dynamic web service agency delivering innovative web development, design, and digital solutions tailored to your business needs.
                  </p>
                </div>
                <div className="col-lg-9 order-md-1 md-mb30">
                  <h1 className="text-u">Always Wanted</h1>
                </div>
              </div>
            </div>
          </div>
