              ...
              <div className="col-lg-5">
                <div className="cont">
                  ...
                  <div>
                    ...
                    <a href="https://unionliving.in/" target='_blank' className="underline mt-15">
                      <span className="text main-color sub-title">
                        View Website <i className="ti-arrow-top-right"></i>
                      </span>
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-5">
                <div className="cont">
                  ...
                  <div>
                    ...
                    <a href="https://meltzsweets.com/" target='_blank' className="underline mt-15">
                      <span className="text main-color sub-title">
              ...
              <div className="col-lg-5">
                <div className="cont">
                  ...
                  <div>
                    ...
                    <a href="https://preppyshoe.com/" target='_blank' className="underline mt-15">
                      <span className="text main-color sub-title">
                        View Websites <i className="ti-arrow-top-right"></i>
                      </span>
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-5">
                <div className="cont">
                  ...
                  <div>
                    ...
                    <a href="https://orex.asynk.in/" target='_blank' className="underline mt-15">
                      <span className="text main-color sub-title">
                        View Details <i className="ti-arrow-top-right"></i>
                      </span>
                    </a>
