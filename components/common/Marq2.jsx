...
function Marq2() {
  const marquess = ['CRM-EMAIL MARKETING-SEO-WE DEVELOPE-BUILD APPS']; // Replace with your actual array
  const AllMarquess = Array(6).fill(marquess).flat();
  const contact = ['WHATSAPP MARKETING-WE DEVELOPE-BUILD APPS']; // Replace with your actual array
